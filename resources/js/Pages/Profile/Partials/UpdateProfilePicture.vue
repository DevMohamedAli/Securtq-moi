...
<template>
    ...
    <div
        ...
        <div class="items-start flex space-s-4">
            ...
            <div>
                <!-- component title -->
                <h3 class="mb-1 text-sm md:text-lg font-bold text-gray-900 dark:text-white">
                    {{ $t("profile.picture") }}
                </h3>
                ...
                <div class="flex items-center space-s-4">
                    <!-- upload btn -->
                    <button type="button" class="icon-style relative" data-tooltip-target="add-avatar">
                    ...
                    <!-- avatar remove btn -->
                    <button type="button" @click="avatarRemove" v-if="$page.props.user.avatar" class="icon-style"
